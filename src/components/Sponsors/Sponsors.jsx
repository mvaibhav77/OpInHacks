   ...
   <div className="container">
      ...
      <div className="row">
        <div className="service">
          ...
          <h2>PROMOTION</h2>
          <p>sponsors will receive comprehensive promotion through all of our social media channels and during off-site events
          </p>
        </div>
        ...
        <img src={employment1} className="fas fa-laptop-code"/>
          <h2>TALENT POOL</h2>
          <p>Sponsoring OpinHacks provides a unique opportunity for companies to access a diverse pool of talented individuals for employment considerations.
          </p>
        </div>
        ...
        <img src={talk1} className="fas fa-laptop-code"/>
          ...
          <p>Being part of OpinHacks will give valuable exposure and help a brand reach a large, engaged audience.
          </p>
        </div>
            ...
            <div className="buttons">
                <button className="brochure" > <a href="#"></a> BROCHURE</button>
                <button className="sponsor-us"> <a href="#"></a> SPONSOR US</button>
            </div>
