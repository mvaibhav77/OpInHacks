...
import Pillarmed from '../../assests/pillar-medium.png'
import Pillarsmall from '../../assests/pillar-small.png'
import Pillarlarge from '../../assests/pillar-large.png'


export const About = () => {
  return (
    <section className='about-section'>
       <h1 className="txt">About Us</h1>
